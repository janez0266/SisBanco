...
<center>
  ...
  <a href="../shared/copying.html"><?php echo $headerLoc->getText("footerGPL"); ?></a><br>
  <?php echo $headerLoc->getText("footerCopyright"); ?> &copy; 2009-Adaptado por SERBILUZ - Unidad de Teleinform&aacute;tica <br> Correo: 
