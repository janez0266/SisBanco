...
<meta name="description" content="Sistema de Banco de Libros">
...
<body bgcolor="<?php echo H(OBIB_PRIMARY_BG);?>" background="../images/fondo1x.jpg" topmargin="0" bottommargin="0" leftmargin="0" rightmargin="0" marginheight="0" marginwidth="0"  <?php
    ...
    <td width="100%" class="title"  valign="top">
       <?php 
         if (OBIB_LIBRARY_IMAGE_URL != "") {
           echo "<center><img align=\"middle\" src=\"".H(OBIB_LIBRARY_IMAGE_URL)."\" border=\"0\"></center>";
         }// echo $headerLoc->getText("headerTodaysDate").H(date($headerLoc->getText("headerDateFormat")));// echo "SERBILUZ - Banco de libros: ";
...
<table class="primary" width="100%" cellpadding="0" cellspacing="0" border="0">
  ...
  <tr bgcolor="<?php echo H(OBIB_TITLE_BG);?>">
    ...
    <td bgcolor="<?php echo H(OBIB_BORDER_COLOR);?>"><img src="../images/shim.gif" width="1" height="1" border="0"></td>
    <td width="2000" bgcolor="<?php echo H(OBIB_TITLE_BG);?>"><img src="../images/shim.gif" width="1" height="1" border="0"></td>
    <td bgcolor="<?php echo H(OBIB_ALT1_BG);?>"><?php echo $headerLoc->getText("headerTodaysDate").H(date($headerLoc->getText("headerDateFormat")));?></td>
