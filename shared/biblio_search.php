...
//  *********   verificaci�n de los ejemplares reservados ***eliminacion de reservas vencidas ***********



//$fecha = "13/01/2009";
//$fecha = "2009-02-28";
$fecha = date("m/d/Y"); //mes/dia/a�o
$fecha_hoy = date("Y-m-d H:i:s");
...
// aqui se puede agregar un contador para saber el numero de Titulos
      if ($biblio->getBibid() == $priorBibid) {
        if ($biblio->getBarcodeNmbr() != "") {
          #************************************
          #* print copy line only
          #************************************
$estado_copia=H($biblioStatusDm[$biblio->getStatusCd()]);
if ($estado_copia == "Desincorporado") { } else {  
          ?>
          <tr>
            ...
            <td class="primary" ><font class="small"><b><?php echo $loc->getText("biblioSearchCopyBCode"); ?></b>: <?php echo H($biblio->getBarcodeNmbr());?>
              <?php if ($lookup == 'Y') { ?>
                <a href="javascript:returnLookup('barcodesearch','barcodeNmbr','<?php echo H(addslashes($biblio->getBarcodeNmbr()));?>')"><?php echo $loc->getText("Alquilar/Devolver"); ?></a> 
| 
              <?php } ?>
            </font>
<?php if ($estado_copia == "Disponible") { ?>
<a href="../new/hold.php?bibid=<?php echo HURL($biblio->getBibid());?>&amp;tab=<?php echo HURL($tab);?>&amp;reg=<?php echo H(addslashes($biblio->getBarcodeNmbr()));?>">Reservar</a> <?php }; ?>
</td>
  ...
  <tr>
    ...
    <td class="primary" valign="top" colspan="2">
 	...
 	<tr>
          <td class="noborder" valign="top"><font class="small"><b><?php echo $loc->getText("Costo Diario Bs.F.");

// procedimiento para traer el costo diario de un libro 
 ...
 ?>:</b></font></td>
          <td class="noborder" colspan="3"><font class="small"><?php echo H($costo_diario);?></font></td>
        </tr>

 <tr>
          <td class="noborder" valign="top"><font class="small"><b><?php echo $loc->getText("Costo Mensual Bs.F."); ?>:</b></font></td>
          <td class="noborder" colspan="3"><font class="small"><?php echo H($costo_mensual);?></font></td>
        </tr>
...
if ($estado_copia == "Desincorporado") { ?><td class="primary" colspan="2" ><center><bold><font class="small"><?php echo $loc->getText("biblioSearchNoCopies"); ?></font></bold></center></td><?php } else {  
      ?>
...
<?  //php echo $loc->getText("biblioSearchCopyBCode"); ------ este comando muestra la traducci�n "C�digo de copia"?> 
<? //php echo $loc->getText("biblioSearchHold");    -----------  Este comando muestra la traducci�n "HOLD"?>


<?php if (H($biblioStatusDm[$biblio->getStatusCd()]) == "Disponible") { ?>
<a href="../new/hold.php?bibid=<?php echo HURL($biblio->getBibid());?>&amp;tab=<?php echo HURL($tab);?>&amp;reg=<?php echo H(addslashes($biblio->getBarcodeNmbr()));?>">Reservar</a>
...
<?php printResultPages($loc, $currentPageNmbr, $biblioQ->getPageCount(), $sortBy); ?><br></center>
