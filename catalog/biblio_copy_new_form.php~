...
<table class="primary">
  ...
  <tr>
    ...
    <td valign="top" class="primary">
      ...
      <input type="checkbox" name="autobarco" value="CHECKED">
 ...
 <!-- <tr>
    <td nowrap="true" class="primary" valign="top">
      <?php //echo $loc->getText("Registro anterior"); ?>:
    </td>
    <td valign="top" class="primary">
      <?php //printInputText("RegAnterior",40,40,$postVars,$pageErrors); ?>
    </td>
  </tr>

 <tr>
    <td nowrap="true" class="primary" valign="top">
      <?php //echo $loc->getText("Siglas Banco"); ?>:
    </td>
    <td valign="top" class="primary">
      <?php //printInputText("Siglas",40,40,$postVars,$pageErrors); ?>
    </td>
  </tr>
-->
