...
?>
  ...
  <tr>
    ...
    <td valign="top" class="primary">
      <?php printSelect("collectionCd","collection_dm",$postVars); ?><a href="javascript:popSecondary('../catalog/tabla.html')">Revisar tabla</a>
    </td>
  </tr>
  <tr>
    <td nowrap="true" class="primary" valign="top">
      <sup>*</sup> <?php echo $loc->getText("DEWEY"); ?>:
    </td>
    <td valign="top" class="primary">
...
<?php // printInputText("callNmbr3",20,20,$postVars,$pageErrors); // modificado JCA?>
    </td>
  </tr>
  <tr>
    <td nowrap="true" class="primary" valign="top">
 ...
 <?php printUsmarcInputText(245,"a",TRUE,$postVars,$pageErrors,$marcTags, $marcSubflds, FALSE,OBIB_TEXT_CNTRL);?>
  ...
  <?php printUsmarcInputText(700,"a",FALSE,$postVars,$pageErrors,$marcTags, $marcSubflds, TRUE,OBIB_TEXT_CNTRL);?>
  ...
  <?php printUsmarcInputText(250,"a",TRUE,$postVars,$pageErrors,$marcTags, $marcSubflds, FALSE,OBIB_TEXT_CNTRL);?>
