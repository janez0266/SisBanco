...
?>
<a href="../admin/mbr_classify_new_form.php?reset=Y"><?php echo $loc->getText("Agregar nueva clasificación"); ?></a><br>
<h1><?php echo $loc->getText("Lista de Clasificación de los miembros"); ?></h1>
<table class="primary">
  <tr>
    <th colspan="2" valign="top"><?php echo $loc->getText("Función"); ?>
      <font class="small">*</font>
    </th>
    <th valign="top">
      <?php echo $loc->getText("Descripción"); ?>
    </th>
    <th valign="top">
...
<td class="noborder"><font class="small"><?php echo $loc->getText("La Función de Borrar sólo está disponible en clasificaciones que no tienen miembros activos. Si desea eliminar una clasificación, verifique primero que los miembros existentes sean cambiados a otra clasificación."); ?><br></font>
</td></tr></table>
