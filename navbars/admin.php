...
<?php if ($nav == "classifications") { ?>
 &raquo; <?php echo $navLoc->getText("Tipos de Usuarios");?><br>
<?php } else { ?>
 <a href="../admin/mbr_classify_list.php" class="alt1"><?php echo $navLoc->getText("Tipo de Usuarios");?></a><br>
<?php } ?>

<?php if ($nav == "member_fields") { ?>
 &raquo; <?php echo $navLoc->getText("Campos de Usuarios");?><br>
<?php } else { ?>
 <a href="../admin/member_fields_list.php" class="alt1"><?php echo $navLoc->getText("Campos de Usuarios ");?></a><br>
<?php } ?>
...
<?php if ($nav == "collections") { ?>
 &raquo; <?php echo $navLoc->getText("Costos de Alquiler");?><br>
<?php } else { ?>
 <a href="../admin/collections_list.php" class="alt1"><?php echo $navLoc->getText("Costos de Alquiler");?></a><br>
<?php } ?>

<?php if ($nav == "checkout_privs") { ?>
 &raquo; <?php echo $navLoc->getText("Opciones de Alquiler");?><br>
<?php } else { ?>
 <a href="../admin/checkout_privs_list.php" class="alt1"><?php echo $navLoc->getText("Opciones de Alquiler");?></a><br>
<?php } ?>
