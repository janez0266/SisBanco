...
$trans["adminFootnote"]            = "\$text = 'Los campos marcados con %symbol% son obligatorios.';";
...
$trans["adminCollections_edit_formNoteText"]                 = "\$text = 'Si pones el valor 0 en los días de devolución, ningún libro de esta colección se podrá prestar.';";
...
$trans["admin_settingsEditsettings"]                 = "\$text = 'Editar las variables de la biblioteca:';";
$trans["admin_settingsLibName"]                 = "\$text = 'Nombre de la biblioteca:';";
$trans["admin_settingsLibimageurl"]                 = "\$text = 'URL de la imagen de la biblioteca:';";
$trans["admin_settingsOnlyshowimginheader"]                 = "\$text = 'Mostrar sólo la imagen en el encabezamiento:';";
$trans["admin_settingsLibhours"]                 = "\$text = 'Horarios de la biblioteca:';";
$trans["admin_settingsLibphone"]                 = "\$text = 'Teléfono de la biblioteca:';";
$trans["admin_settingsLibURL"]                 = "\$text = 'Ruta URL de la biblioteca:';";
$trans["admin_settingsOPACURL"]                 = "\$text = 'Ruta OPAC:';";
...
$trans["admin_settingsPurgebibhistory"]                 = "\$text = 'Depurar el historial de la bibliografía:';";
$trans["admin_settingsmonths"]                 = "\$text = 'meses';";
$trans["admin_settingsBlockCheckouts"]                 = "\$text = 'Bloquear los préstamos cuando haya pendiente una sanción:';";
$trans["admin_settingsLocale"]                 = "\$text = 'Localización:';";
$trans["admin_settingsHTMLChar"]                 = "\$text = 'Código de caracteres HTML:';";
...
#****************************************************************************
$trans["adminStaff_del_confirmConfirmText"]                 = "\$text = 'estás seguro de querer borrar a un bibliotecario, ';";
...
#****************************************************************************
$trans["adminStaff_edit_formHeader"]                 = "\$text = 'Editar información de los bibliotecarios:';";
$trans["adminStaff_edit_formLastname"]                 = "\$text = 'Apellidos:';";
$trans["adminStaff_edit_formFirstname"]                 = "\$text = 'Nombre:';";
$trans["adminStaff_edit_formLogin"]                 = "\$text = 'Nombre de usuario:';";
$trans["adminStaff_edit_formAuth"]                 = "\$text = 'Autorización:';";
...
$trans["adminStaff_edit_formSuspended"]                 = "\$text = 'Bloqueado:';";

#****************************************************************************
#*  Translation text for page staff_list.php
#****************************************************************************
$trans["adminStaff_list_formHeader"]                 = "\$text = 'Añadir nuevo bibliotecario';";
$trans["adminStaff_list_Columnheader"]                 = "\$text = 'Bibliotecarios:';";
...
#****************************************************************************
$trans["adminStaff_new_form_Header"]          	= "\$text = 'Añadir nuevo bibliotecario:';";
...
#****************************************************************************
$trans["adminStaff_pwd_reset_Passwordreset"]   = "\$text = 'La contraseña ha sido restaurada.';";
...
$trans["adminTheme_Addnew"]                 = "\$text = 'Añadir nuevo tema';";
...
$trans["adminTheme_Notetext"]                 = "\$text = 'la función de borrado no está disponible en el tema que está en uso actualmente.';";
...
$trans["adminTheme_Navigation"]                 = "\$text = 'Navegación';";
...
$trans["adminTheme_preview_Librarytitle"]                 = "\$text = 'título de la biblioteca';";
