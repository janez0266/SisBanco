...
$trans["indexIntro"]         = "\$text= 'Utiliza las pestañas superiores para acceder a las diferentes páginas de administración del Sistema.';";
$trans["indexTab"]           = "\$text='Página (pestaña)';";
$trans["indexDesc"]          = "\$text='Descripción';";
$trans["indexCirc"]          = "\$text='Alquiler ';";
$trans["indexCircDesc1"]     = "\$text='Utiliza esta página para administrar los datos de los usuarios.';";
$trans["indexCircDesc2"]     = "\$text='Administración de Usuarios (añadir nuevos, buscar, editar, borrar)';";
$trans["indexCircDesc3"]     = "\$text='Alquiler, reservas, cuentas e historial de los Usuarios de la biblioteca';";
$trans["indexCircDesc4"]     = "\$text='Devolución de bibliografía y del carrito de reposición en estantería';";
$trans["indexCircDesc5"]     = "\$text='Pago de alquileres y otros ingresos';";
$trans["indexCat"]           = "\$text='Catalogación';";
...
$trans["indexAdminDesc1"]    = "\$text='Administración del Personal y de datos administrativos.';";
$trans["indexAdminDesc2"]    = "\$text='Administración del personal (añadir nuevos, editar, cambiar contraseñas, borrar)';";
