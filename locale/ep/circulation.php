...
$trans["mbrDupBarcode"]           = "\$text = 'Registro, %barcode%, ya está en uso.';";
#****************************************************************************
#*  Translation text for page index.php
#****************************************************************************
$trans["indexHeading"]            = "\$text='Circulación';";
$trans["indexCardHdr"]            = "\$text='Buscar Usuario por número de Cédula:';";
$trans["indexCard"]               = "\$text='Número de Cédula:';";
...
$trans["mbrFldsCardNmbr"]         = "\$text='Número de Cédula:';";
...
$trans["mbrsearchCardNumber"]     = "\$text='Número de Cédula:';";
...
$trans["mbrViewCardNmbr"]         = "\$text='Número de Cédula:';";
...
$trans["mbrViewOutHdr6"]          = "\$text='Fecha devolución';";
$trans["mbrViewOutHdr7"]          = "\$text='Días transcurridos';";
...
$trans["mbrViewHoldHdr8"]         = "\$text='Fecha devolución';";
...
$trans["mbrPrintCheckouts"]	  = "\$text='Imprimir selección';";
...
$trans["checkoutErr1"]            = "\$text='El número del Registro debe ser completamente alfanumérico.';";
$trans["checkoutErr2"]            = "\$text='No se encontró bibliografía con ese Registro.';";
$trans["checkoutErr3"]            = "\$text='La bibliografía con el Registro %barcode% ya ha sido alquilada.';";
$trans["checkoutErr4"]            = "\$text='La bibliografía con Registro número %barcode% no está disponible para el alquiler.';";
$trans["checkoutErr5"]            = "\$text='La bibliografía con Registro número %barcode% está actualmente siendo utilizada por otro Usuario.';";
$trans["checkoutErr6"]            = "\$text='El Usuario ha alcanzado el tiempo límite de alquiler en el tipo de material bibliográfico especificado.';";
$trans["checkoutErr7"]            = "\$text='El item con Registro %barcode% ha alcanzo el limite para su renovación.';";
...
#****************************************************************************
$trans["shelvingCartErr1"]        = "\$text='El número del Registro debe ser completamente alfanumérico.';";
$trans["shelvingCartErr2"]        = "\$text='No se encontró ninguna bibliografía con ese número de Registro.';";
$trans["shelvingCartTrans"]       = "\$text='Monto a pagar por la devolución (Registro=%barcode%)';";
#****************************************************************************
...
$trans["checkinFormColHdr1"]      = "\$text='Fecha de devolución';";
...
#****************************************************************************
$trans["holdMessageHdr"]          = "\$text='Bibliografía ha sido Reservada!';";
$trans["holdMessageMsg1"]         = "\$text='La bibliografía con el registro %barcode% que quieres seleccionar posee uno o más requerimientos de Reserva.  <b>Por favor archive esta bibliografía con sus artículos en reserva en vez de colocarlo en su carro de estanterías.</b>  El status de esta bibliografia es Reservado.';";
$trans["holdMessageMsg2"]         = "\$text='Regreso a Devoluciones.';";

$trans["holdMessageHdr"]          = "\$text='La bibliografía está alquilada!';";
$trans["holdMessageMsg1"]         = "\$text='La bibliografía con número de Registro %barcode% que estás intentando conseguir tiene una o más peticiones de reserva.  <b>Por favor, retorna el item en las estanterías .</b>  El código de estado de esta bibliografía ha quedado libre para su uso.';";
$trans["holdMessageMsg2"]         = "\$text='Volver a la devolución del Items.';";
#****************************************************************************
#*  Translation text for page place_hold.php
#****************************************************************************
$trans["placeHoldErr1"]           = "\$text='El Registro debe ser numérico.';";
$trans["placeHoldErr2"]           = "\$text='El Registro no existe.';";
$trans["placeHoldErr3"]           = "\$text='El Usuario canceló la reserva del item -- No Reservado.';";
...
$trans["mbrDelConfirmMsg"]        = "\$text = 'Estás seguro de que quieres borrar al Usuario, %name%?  Esto también borrará todo el historial de alquileres de este Usuario.';";
...
$trans["mbrPrintCheckoutsHdr3"]   = "\$text='Número de Cédula:';";
