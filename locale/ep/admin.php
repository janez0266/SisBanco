...
#****************************************************************************
$trans["indexHdr"]                 = "\$text = 'Administracion';";
$trans["indexDesc"]                = "\$text = 'Utiliza las funciones de la zona de la izquierda para administrar al personal y los datos administrativos.';";
#****************************************************************************
#*  Translation text for page checkout_priv_*.php
#****************************************************************************
$trans["Edit_Checkout_Privileges"]      = "\$text = 'Edición de privilegios de Alquileres';";
$trans["Material_Type_m"]                 = "\$text = 'Tipo de Material: ';";
$trans["Member_Classification"]         = "\$text = 'Tipo de Usuario: ';";
$trans["Checkout_Limit_max"]                 = "\$text = 'Límite de Alquileres ';";
$trans["Renewal_Limit_max"]                 = "\$text = 'Límite de Renovacion ';";
$trans["op_alquiler"]                 = "\$text = 'Opciones de Alquiler ';";
$trans["op_editar"]                 = "\$text = 'Editar ';";
#****************************************************************************
#*  Translation text for page collections*.php
#****************************************************************************
$trans["adminCollections_delReturn"]                 = "\$text = 'Volver a la lista de Costos de Alquiler';";
$trans["adminCollections_delStart"]                 = "\$text = 'Costos de Alquiler, ';";
#****************************************************************************
...
#****************************************************************************
$trans["adminCollections_del_confirmText"]                 = "\$text = '¿Estás seguro de que quieres borrar esta opción?, ';";
#****************************************************************************
...
#****************************************************************************
$trans["adminCollections_edit_formEditcollection"]                 = "\$text = 'Editar Costo:';";
...
$trans["adminCollections_edit_formDailyLateFee"]                 = "\$text = 'Costo diario por Alquiler:';";
$trans["adminCollections_edit_formNote"]                 = "\$text = '*Notas:';";
$trans["adminCollections_edit_formNoteText"]                 = "\$text = 'Si se coloca los días de devolución en 0, ningún libro de esta colección se podrá prestar.';";
#****************************************************************************
#*  Translation text for page collections_list.php
#****************************************************************************
$trans["adminCollections_listAddNewCollection"]                 = "\$text = 'Añadir nuevo nivel de costo';";
$trans["adminCollections_listCollections"]                 = "\$text = 'Costos de alquiler:';";
$trans["adminCollections_listFunction"]                 = "\$text = 'Función';";
$trans["adminCollections_listDescription"]                 = "\$text = 'Descripción';";
$trans["adminCollections_listDaysdueback"]                 = "\$text = 'Días<br>exentos<br>de pago';";
$trans["adminCollections_listDailylatefee"]                 = "\$text = 'Costo de alquiler<br>diario';";
$trans["adminCollections_listBibliographycount"]                 = "\$text = 'Número<br>libros<br>actualmente<br>alquilados';";
...
$trans["adminCollections_ListNoteText"]                 = "\$text = 'La función de borrado sólo está disponible en aquellos Niveles de Costo que tengan una cuenta de libros actualmente alquilados en cero.<br>Si deseas borrar una Nivel de Costo con una cuenta bibliográfica mayor de cero primero tendrás que cambiar el Nivel de Costo de esas bibliografías a otro Nivel de Costo.';";
#****************************************************************************
...
#****************************************************************************
$trans["adminCollections_new_formAddnewcollection"]                 = "\$text = 'Añadir nuevo Nivel de Costo:';";
$trans["adminCollections_new_formDescription"]                 = "\$text = 'Descripción:';";
$trans["adminCollections_new_formDaysdueback"]                 = "\$text = 'Días exentos de pago:';";
$trans["adminCollections_new_formDailylatefee"]                 = "\$text = 'Costo de alquiler diario:';";
$trans["adminCollections_new_formNote"]                 = "\$text = '*Nota:';";
$trans["adminCollections_new_formNoteText"]                 = "\$text = ' Si se coloca los días de devolución en 0, ningún libro de este nivel de precios se podrá prestar..';";
#****************************************************************************
...
#****************************************************************************
$trans["admin_materials_delAreyousure"]                 = "\$text = '¿Estás seguro de que quieres borrar este tipo de material?, ';";
...
$trans["admin_materials_delNoteText"]                 = "\$text = 'Los archivos de imagen deben estar en el directorio sisbanco/images.';";
...
$trans["admin_materials_listCheckoutlimit"]     = "\$text = 'Límite de Alquiler';";
...
#****************************************************************************
$trans["admin_materials_new_formNoteText"] = "\$text = 'los archivos de imagen deben localizarse en el directorio sisbanco/images.';";
#****************************************************************************
#*  Translation text for page noauth.php
#****************************************************************************
$trans["admin_noauth"] = "\$text = 'no estás autorizado a utilizar el Admin tab.';";
...
$trans["admin_settingsEditsettings"]           = "\$text = 'Editar configuración de la biblioteca:';";
$trans["admin_settingsLibName"]                = "\$text = 'Nombre de la biblioteca:';";
$trans["admin_settingsLibimageurl"]            = "\$text = 'Imagen URL de la biblioteca:';";
$trans["admin_settingsOnlyshowimginheader"]    = "\$text = 'Sólo mostrar la imagen en el encabezamiento:';";
...
$trans["admin_settingsBlockCheckouts"]         = "\$text = 'Bloquear los Alquileres cuando haya pendiente una deuda:';";
...
$trans["adminStaff_Return"]      = "\$text = 'Volver a la lista del Personal';";
...
#****************************************************************************
$trans["adminStaff_edit_formHeader"]     = "\$text = 'Editar información de los miembros del personal:';";
...
$trans["adminStaff_edit_formAuth"]       = "\$text = 'Atributos:';";
...
#****************************************************************************
$trans["adminStaff_list_formHeader"]  = "\$text = 'Añadir nuevo miembro al personal';";
$trans["adminStaff_list_Columnheader"]= "\$text = ' Lista miembros del personal:';";
$trans["adminStaff_list_Function"]    = "\$text = 'Función';";
...
#****************************************************************************
$trans["adminStaff_pwd_reset_Passwordreset"]   = "\$text = 'La contraseña ha sido reseteada.';";

#****************************************************************************
#*  Translation text for page staff_pwd_reset_form.php
#****************************************************************************
$trans["adminStaff_pwd_reset_form_Resetheader"]   = "\$text = 'Borrar contraseña de bibliotecario:';";
...
#****************************************************************************
$trans["adminTheme_Deleteconfirm"] = "\$text = '¿Estás seguro de que quieres borrar este tema?, ';";
#****************************************************************************
...
$trans["adminTheme_Preview"]= "\$text = 'Previsualizar los cambios del diseño';";
...
$trans["adminTheme_Notetext"]     = "\$text = 'La función de borrado no está disponible porque el diseño seleccionado está en uso.';";
#****************************************************************************
#*  Translation text for page theme_list.php
#****************************************************************************
...
$trans["adminTheme_Linkcolor"]              = "\$text = 'Color de los links:';";
...
$trans["adminTheme_preview_Poweredby"]     = "\$text = 'EspaBiblio power by Openbiblio';";
$trans["adminTheme_preview_Copyright"]     = "\$text = 'Copyright &copy; 2002 Dave Stevens OpenBiblio - Jorge Lara EspaBiblio';";
$trans["adminTheme_preview_underthe"]      = "\$text = 'Bajo la';";
$trans["adminTheme_preview_GNU"]           = "\$text = 'Licencia general Pública de la GNU';";
#****************************************************************************
